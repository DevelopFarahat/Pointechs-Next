...
function Signup(props) {
  ...
  const navigateToSignInForm = (event) => {
    event.preventDefault()
    event.stopPropagation();
    props.onHide();
    props.setLoginModalShow(true);
    push({ pathname, query: { status: "login-popup" } }, undefined, {
      locale,
      scroll: false,
      shallow: true,
    });
    ...
    <>
      ...
      >
        <Modal.Body className={SignupStyles["signup-model-body"]}>
          ...
          <section
            className={SignupStyles["signup-form-container"]}
          ...
          >
            ...
            >
              <span onClick={handleOnHide}>
                <GrFormClose style={{ color: "#27323C" }} />
              </span>
            </div>
            <form
            ...
            >
              ...
              {activeTap.personalInfoTapVisible ? (
                      ...
                      <>
                        <Select
                          className={`basic-select-phone-code ${
                            locale == "ar"
                              ? SignupStyles["country-select-ar"]
                              : ""
                          }`}
                ...
                <div className={SignupStyles["account-details"]}>
                  ...
                  <div>
                    ...
                    <label
                      htmlFor="termsOfServiceStatus"
                      style={{ textAlign: locale == "en" ? "left" : "right" }}
                    >
                      {t("By confirming your data, you agree to")}{" "}
                      <Link onClick={navigateToTermsAndConditions} href={"#"}>
              ...
              <span>
                ...
                <Link href={"#"} onClick={navigateToSignInForm} locale={locale}>
                  {t("Sign In")}
                </Link>
              </span>
            </form>
