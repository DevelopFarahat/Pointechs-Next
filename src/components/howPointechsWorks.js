...
const  HowPointechsWorks = forwardRef(({ metaTitle,onHeaderLinkClick },ref)=> {
  ...
  useEffect(() => {
    ...
    if (section == "how-it-works") {
      onHeaderLinkClick("how-it-works");
      setSelectedLink(4);
  ...
  return (
    <>
      ...
      <div
        className={HowPointechsStyles["how-pointechs-works"]}
        id="how-it-works"
        ref={ref}
      >
        <main>
          <div style={{ order: locale == "en" ? 2 : 2 }}>
            <Image
              src={HowPointechsWorksImg}
              loading="lazy"
              alt="how-pointechs-works"
            />
          </div>
                ...
                <div key={step.id}>
                  <div>
                    <Image
                      ...
                      alt={
                        step.icon.src
                          .substr(step.icon.src.lastIndexOf("/") + 1)
                          .split(".")[0]
                      }
                    />
                  </div>
