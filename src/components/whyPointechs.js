...
const  WhyPointechs = forwardRef(({ metaTitle,onHeaderLinkClick },ref)=> {
  ...
  return (
    <>
      ...
      <div className={whyPointehsStyles["why-pointechs"]} id="why-us" ref={ref}>
        <main>
          <section>
            <div>
              <main>
