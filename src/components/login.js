...
function Login(props) {
  ...
  useEffect(() => {
    const { status } = query;
    if (status == "login-popup") {
      const { setLoginModalShow } = props;
      if (setLoginModalShow != undefined) setLoginModalShow(true);
    }
  }, []);
...
<Modal
    ...
    >
      <Modal.Body className={LoginStyles["login-body-modal"]}>
        ...
        <section
          className={LoginStyles["login-form-container"]}
            ...
            <form className={LoginStyles["login-form"]} onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  name="email"
                  id="email"
                  className={`${errors.emailError ? "input-is-invalid" : ""}`}
              ...
              <div>
                ...
                <div>
                  <div
                    ...
                    ref={passwordRef}
                    className={`${
                      errors.passwordError ? "input-is-invalid" : ""
                    }`}
                  >
                    <input
                      type={tooglePassword}
              ...
              <Link className={LoginStyles["register-now-link"]} href={"#"}>
                {t("Create an account")}
                <span onClick={navigateToSignupForm}>{t("Register Now")}</span>
              </Link>
            </form>
          </div>
        </section>
